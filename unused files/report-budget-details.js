...
function renderBudgetTable() {
    ...
    currentData.forEach(row => {
        let rowClass = ''; // Base class for styling
        ...
        const clickableAttr = isCapitalItem ? `onclick="handleCapitalRowClick('${row.code}', '${row.name}')"` : '';
...
function handleCapitalRowClick(itemCode, itemName) {
    ...
    loadScreen('screens/report-capital-ledger.html', null, `${itemName} Ledger`);
}
